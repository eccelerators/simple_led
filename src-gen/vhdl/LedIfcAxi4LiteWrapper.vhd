...
entity LedIfcAxi4LiteWrapper is
	port (
		Clk : in std_logic;
		Rst : in std_logic;
		...
		Trace_Axi4LiteDown_AWADDR : out std_logic_vector(3 downto 0);
		...
		Trace_Axi4LiteDown_ARADDR : out std_logic_vector(3 downto 0);
		...
		LedBlkDown_OnOff : out std_logic
	);
end;

architecture Behavioural of LedIfcAxi4LiteWrapper is

	signal Axi4LiteDown : T_LedIfcAxi4LiteDown;
	signal Axi4LiteUp : T_LedIfcAxi4LiteUp;
	signal Trace : T_LedIfcTrace;
	signal LedBlkDown : T_LedIfcLedBlkDown;
	signal Axi4LiteAccess : T_LedIfcAxi4LiteAccess;

begin

	LedIfcAxi4Lite_i : entity work.LedIfcAxi4Lite
	port map (
		Clk => Clk,
		Rst => Rst,
	...
	LedBlkDown_OnOff <= LedBlkDown.OnOff;
